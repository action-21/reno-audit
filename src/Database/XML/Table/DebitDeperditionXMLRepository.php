...
use App\Domain\Moteur3CL\Deperdition\Ventilation\Table\{Debit, DebitRepository};

class DebitDeperditionXMLRepository extends DebitXMLRepository implements DebitRepository
{
