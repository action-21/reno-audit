...
use App\Domain\Audit\PlancherBas\PlancherBas;
...
final class DeperditionPlancherBasCommand
{
    ...
    {
        return new self(
            perimetre: $entity->perimetre(),
            surface: $entity->surface(),
            surface_pleine: $entity->surface_pleine(),
            upb_saisi: $entity->upb_saisi(),
            upb0_saisi: $entity->upb0_saisi(),
            ...
            type_plancher_bas: $entity->type_plancher_bas(),
